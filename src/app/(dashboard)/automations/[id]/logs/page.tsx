    ...
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="mt-0.5 text-sm text-slate-400">Historial de ejecución</p>
        </div>
      </div>
      ...
      {logs.length === 0 ? (
        <div className="flex h-48 flex-col items-center justify-center rounded-xl border border-dashed border-slate-800 bg-slate-900/40">
          <p className="text-sm text-white">Aún no hay ejecuciones</p>
          <p className="mt-1 text-xs text-slate-400">
            Activa esta regla para ver ejecuciones aquí.
          </p>
        </div>
      ) : (
