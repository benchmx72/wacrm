    ...
    <TooltipProvider>
      <div className="grid grid-cols-2 gap-3 rounded-xl border border-slate-800 bg-slate-900/60 p-4 sm:grid-cols-3 xl:grid-cols-6">
        <Metric
          ...
          label={t("pipelinesPage.analytics.totalDeals")}
          value={String(stats.totalCount)}
          tooltip={t("pipelinesPage.analytics.totalDealsTooltip")}
        />
        <Metric
          icon={<DollarSign className="h-4 w-4 text-primary" />}
          label={t("pipelinesPage.analytics.pipelineValue")}
          value={formatCurrency(stats.totalValue)}
          tooltip={t("pipelinesPage.analytics.pipelineValueTooltip")}
        />
        <Metric
          icon={<Target className="h-4 w-4 text-blue-400" />}
          label={t("pipelinesPage.analytics.avgDealSize")}
          value={formatCurrency(stats.avgValue)}
          tooltip={t("pipelinesPage.analytics.avgDealSizeTooltip")}
        />
        <Metric
          icon={<TrendingUp className="h-4 w-4 text-purple-400" />}
          label={t("pipelinesPage.analytics.weightedValue")}
          value={formatCurrency(stats.weightedValue)}
          tooltip={t("pipelinesPage.analytics.weightedValueTooltip")}
        />
        <Metric
          icon={<Trophy className="h-4 w-4 text-primary" />}
          label={t("pipelinesPage.analytics.wonThisMonth")}
          value={String(stats.wonThisMonth)}
          tooltip={t("pipelinesPage.analytics.wonThisMonthTooltip")}
        />
        <Metric
          icon={<XCircle className="h-4 w-4 text-red-400" />}
          label={t("pipelinesPage.analytics.lostThisMonth")}
          value={String(stats.lostThisMonth)}
          tooltip={t("pipelinesPage.analytics.lostThisMonthTooltip")}
        />
      </div>
    </TooltipProvider>
  );
        ...
        <Tooltip>
          <TooltipTrigger
            render={
              <button
                type="button"
                aria-label={t("pipelinesPage.analytics.howCalculated", {
                  label,
                })}
